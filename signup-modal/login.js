...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (letter.classList.value == capital.classList.value && length.classList.value == match.classList.value && number.classList.value == "valid") ; // TODO: Replace false with the correct condition
